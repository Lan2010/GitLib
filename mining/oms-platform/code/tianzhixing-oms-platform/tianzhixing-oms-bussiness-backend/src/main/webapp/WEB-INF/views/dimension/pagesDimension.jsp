          ...
          <div class="row">
            <form role="form" class="form-horizontal" id="create_form">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-6">
                  <input type="text" class="form-control" placeholder="请输入值" id="url" name="url">
                </div>
              </div>
...
<script src="${ctx}/statics/javascripts/modules/dimension/pagesDimensionController.js?v=1.0.49"></script>
</body>
</html>