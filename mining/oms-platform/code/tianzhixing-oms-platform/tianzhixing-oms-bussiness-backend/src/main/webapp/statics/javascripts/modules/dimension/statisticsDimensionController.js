$(function(){
	...
	var $create_form = $("#create_form"),
        ...
        $table = $("#table"),
        url = "dimension/",
        urlList = url + "applicationDimension/list",
        urlCreate = url + "applicationDimension/add",
        urlDetail = url + "applicationDimension/detail",
        urlUpdateInfo = url + "applicationDimension/update";
    ...
    $.ajax({ 
    	type:"GET", 
    	cache:false, 
    	url : "/dimension/applicationDimension/list", 
    	async:true, 
    	data:{
    		"pageNo":1,
    		"pageSize":10000
    	...
    	$('#parentId.form-control').append("<option value=" + list[i].id + ">" + list[i].name + "</option>");
    	});
    	}
    	});
});
