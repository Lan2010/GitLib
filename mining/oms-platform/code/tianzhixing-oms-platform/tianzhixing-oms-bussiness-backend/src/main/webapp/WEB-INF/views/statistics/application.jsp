        ...
        <div class="ibox float-e-margins">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <div class="row">
                        <div class="col-sm-4">
                            <div id="canvas-holder-application-pie" >

                            </div>
                        </div>
                        <div class="col-sm-8">
                            <div id="canvas-holder-application-line" style="width: 100%;">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="ibox-content">
                    <div class="row">
                        <div class="col-sm-4">
                            <div id="canvas-holder-application-diffip-pie" >
                            </div>
                        </div>
                        <div class="col-sm-8">
                            <div id="canvas-holder-application-diffip-line" style="width: 100%;">
                            </div>
                        </div>
                    </div>
                </div>
...
<script src="${ctx}/statics/javascripts/modules/statistics/applicationStatisticsController.js?v=1.0.9"></script>
</body>
</html>