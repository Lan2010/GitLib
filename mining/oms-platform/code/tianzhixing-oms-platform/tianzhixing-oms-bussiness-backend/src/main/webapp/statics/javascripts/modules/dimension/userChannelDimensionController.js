$(function(){
	...
	var $create_form = $("#create_form"),
        ...
        $table = $("#table"),
        url = "dimension/",
        urlList = url + "userChannelDimension/list",
        urlCreate = url + "userChannelDimension/add",
        urlDetail = url + "userChannelDimension/detail",
        urlUpdateInfo = url + "userChannelDimension/update";
