...
<body class="gray-bg">
			...
			<div class="ibox float-e-margins">
				<div class="ibox float-e-margins">
					...
					<div class="ibox-content">
						<div class="row">
							<div class="col-sm-4">
								<div id="canvas-holder-device-pie"></div>
							</div>
							<div class="col-sm-8">
								<div id="canvas-holder-device-line" style="width: 100%;"></div>
							</div>
						</div>
					</div>
					<div class="ibox-content">
					...
					<div class="ibox-content">
						<div class="row">
							<div>
								<div id="canvas-holder-Device-line-ByDeviceType" style="width: 100%;"></div>
							</div>
						</div>
					</div>
				</div>
	...
	<script src="${ctx}/statics/javascripts/modules/statistics/deviceStatisticsController.js?v=1.0.9"></script>
</body>
</html>