...
<body class="gray-bg">
	<div class="">
		<div class="wrapper wrapper-content animated fadeInRight">
			<div class="ibox float-e-margins">
				<div class="ibox float-e-margins">
					...
					<div class="ibox-content">
						<div class="row">
							<div class="col-sm-4">
								<div id="canvas-holder-userinfo-pie"></div>
							</div>
							<div class="col-sm-8">
								<div id="canvas-holder-userinfo-line" style="width: 100%;"></div>
							</div>
						</div>
					</div>
					<div class="ibox-content">
					...
					<div class="ibox-content">
						<div class="row">
							<div class="col-sm-4">
								<div id="canvas-holder-userinfo-channel-pie"></div>
							</div>
							<div class="col-sm-8">
								<div id="canvas-holder-userinfo-channel-line" style="width: 100%;"></div>
							</div>
						</div>
					</div>
					<div class="ibox-content">
			...
			<div class="ibox-content">
				<div class="row">
					<div>
						<div id="canvas-holder-userinfo-channel-scatter-line" style="width: 100%;"></div>
					</div>
				</div>
			</div>
		</div>
	...
	<script src="${ctx}/statics/javascripts/modules/statistics/userInfoStatisticsController.js?v=1.0.22"></script>
</body>
</html>