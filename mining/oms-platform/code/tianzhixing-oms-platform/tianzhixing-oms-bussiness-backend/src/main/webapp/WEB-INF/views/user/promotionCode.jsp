...
<body class="gray-bg">
						...
						<div class="row">
							<form role="form" class="form-horizontal" id="update_form">
								...
								<div class="form-group">
									...
									<div class="col-sm-6">
										<select class="form-control" id="isExpired_update" name="isExpired">
											<option value="0">否</option>
											<option value="1">是</option>
										</select>
									</div>
	...
	<script src="${ctx}/statics/javascripts/modules/user/promotionCodeController.js?v=1.0.43"></script>
</body>
</html>