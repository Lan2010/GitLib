...
import com.tianzhixing.oms.bussiness.model.annotation.Transient;
...
public class GenericBaseDao<T extends Serializable, PK extends Serializable> extends
    ...
    @Override
    public Map<String, Object> getProperties(String sql, String[] propertiesMap) {
        return _getProperties(sql, null, propertiesMap);
    }
    ...
    @Override
    public List<Map<String, Object>> listProperties(String sql, String[] propertiesMap) {
        return _listProperties(sql, null, propertiesMap);
    }
