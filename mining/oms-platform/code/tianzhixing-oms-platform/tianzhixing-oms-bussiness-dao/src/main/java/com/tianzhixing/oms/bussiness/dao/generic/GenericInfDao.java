package com.tianzhixing.oms.bussiness.dao.generic;
...
public abstract interface GenericInfDao<T, PK extends Serializable> {
     ...
     * @return
     */
    abstract Object getProperty(String sql);
    ...
    List<Object> listProperty(String sql, String property);
     ...
     * @return
     */
    abstract List<Object> listProperty(final String property, final PK id);
     ...
     * @return
     */
    abstract List<Object> listProperty(final String property, final String[] properties, final Object[] propertyValues);
     ...
     * @return
     */
    abstract List<Object> listProperty(final String property, final String propertyName, final Object obj);
     ...
     * @return
     */
    abstract Map<String, Object> getProperties(final String sql, final String[] propertiesMap);
     ...
     * @return
     */
    abstract Map<String, Object> getProperties(final String[] propertiesMap, final PK id);
     ...
     * @return
     */
    abstract Map<String, Object> getProperties(final String[] propertiesMap, final String[] properties, final Object[] propertyValues);
     ...
     * @return
     */
    abstract Map<String, Object> getProperties(final String[] propertiesMap, final String propertyName, final Object obj);
     ...
     * @return
     */
    abstract List<Map<String, Object>> listProperties(final String[] propertiesMap, final PK id);
     ...
     * @return
     */
    abstract List<Map<String, Object>> listProperties(String sql, String[] propertiesMap);
     ...
     * @return
     */
    abstract List<Map<String, Object>> listProperties(final String[] propertiesMap, final String[] properties, final Object[] propertyValues);
     ...
     * @return
     */
    abstract List<Map<String, Object>> listProperties(final String[] propertiesMap, final String propertyName, final Object obj);
