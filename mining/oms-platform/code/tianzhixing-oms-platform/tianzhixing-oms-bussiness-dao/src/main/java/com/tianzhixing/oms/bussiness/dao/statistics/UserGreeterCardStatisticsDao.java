 ...
 */
@Repository("userGreeterCardStatisticsDao")
public class UserGreeterCardStatisticsDao extends GenericBaseDao<UserGreeterCardStatisticsModel, Long> {
    ...
    public List<Map<String, Object>> listSum(final Integer statisticsDay, final Integer statisticsMonth, final Integer statisticsYear) {
        ...
        String sql = _condition(conditionBuffer.append(" from user_greeter_card_statistics where 1 = 1 "), null, statisticsDay, statisticsMonth, statisticsYear) + groupBuffer.toString();
