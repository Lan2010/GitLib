 ...
 */
@Repository("deviceOperationStatisticsDao")
public class DeviceOperationStatisticsDao extends GenericBaseDao<DeviceOperationStatisticsModel, Long> {
     ...
     * @return
     */
    private String _condition(StringBuffer sql, Integer statisticsHour, Integer statisticsDay, Integer statisticsMonth, Integer statisticsYear, String clientPlatformType, String platformFrom, String deviceType) {
     ...
     * @return
     */
    public List<Map<String, Object>> listSum(final Integer statisticsDay, final Integer statisticsMonth, final Integer statisticsYear, final String clientPlatformType, final String platformFrom, final String deviceType) {
        StringBuffer conditionBuffer = new StringBuffer("select sum(device_bind_count) as deviceBindCount, sum(device_unbind_count) as deviceUnBindCount");
        StringBuffer groupBuffer = new StringBuffer(" group by statistics_year, statistics_month ");
        List<String> properties = new ArrayList<>();
        properties.add("deviceBindCount");
        properties.add("deviceUnBindCount");
        ...
        String sql = _condition(conditionBuffer.append(" from device_operation_statistics where 1 = 1 "), null, statisticsDay, statisticsMonth, statisticsYear, clientPlatformType, platformFrom, deviceType) + groupBuffer.toString();
