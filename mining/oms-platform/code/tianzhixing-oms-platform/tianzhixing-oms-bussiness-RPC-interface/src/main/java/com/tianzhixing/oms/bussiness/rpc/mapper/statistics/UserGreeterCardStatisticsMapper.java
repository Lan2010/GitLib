 ...
 */
public class UserGreeterCardStatisticsMapper implements Serializable {
    ...
    public UserGreeterCardStatisticsMapper(Long id, Integer version, Date createTime, Integer statisticsHour, Integer statisticsDay, Integer statisticsMonth, Integer statisticsYear, String clientPlatformType, String platformFrom, Integer createCount, Integer shareCount, String platformName) {
		this.id = id;
	...
	public UserGreeterCardStatisticsMapper() {
	}
