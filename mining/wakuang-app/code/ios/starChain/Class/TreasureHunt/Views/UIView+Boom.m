...
const static NSInteger cellCount = 18;
const static NSTimeInterval duration = 0.35;
...
- (void)boomComplete:(void (^)(void))complete {
    ...
    [self cellAnimation];
    [self scaleOpacityAnimationsComplete:complete];
}
...
#pragma mark - 缩放透明度动画
- (void)scaleOpacityAnimationsComplete:(void (^)(void))complete {
    ...
    [self.layer addAnimation: animationGroup forKey: @"disappearAnimation"];
