 ...
 */
+ (void)addToShoppingCartWithGoodsImage:(UIImage *)goodsImage startPoint:(CGPoint)startPoint endPoint:(CGPoint)endPoint start:(void (^)(CAShapeLayer *, UIView *))start completion:(void (^)(BOOL))completion {
    ...
    if (start) start(animationLayer, rootVC.view);
