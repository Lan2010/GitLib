...
abstract class BaseMobileController extends BaseController {
    ...
    protected $headers;
    public $loginURL = "User/login"; //需要有微信授权
    public $registerURL = "User/register"; //需要有微信授权
    protected $appLoadLink = "http://a.app.qq.com/o/simple.jsp?pkgname=com.qianhezi.qhz";
    public $seoInfo = ['title' => '钱盒子金融', 'keyword' => '钱盒子金融', 'description' => '钱盒子金融'];
