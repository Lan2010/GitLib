...
return array(
    ...
    'DB_USER' => 'root', // 用户名  
    'DB_HOST' => '192.168.11.13', // 服务器地址
    'DB_NAME' => 'starchain', // 数据库名
    'DB_PORT' => '3306', // 端口
    'DB_PWD' => 'abc123#@!', // 密码
    'DB_PREFIX' => 'd_', // 数据库表前缀 */
    ...
    'DB_PARAMS' => array(\PDO::ATTR_CASE => \PDO::CASE_NATURAL),
    // 允许访问列表和默认模块
    'MODULE_ALLOW_LIST' => array('Frontend', 'Backend', 'Api','Wechat', 'MobileApi'),
    ...
    'REDIS_AUTH' => 'sky!@#123',
    'REDIS_HOST' => '192.168.11.16',
    'REDIS_PORT' => 6379,
    //'REDIS_HOST' => '192.168.0.238',  
    'DATA_CACHE_PREFIX' => '',
    'DATA_CACHE_TIME' => 3600,
//    'APP_SUB_DOMAIN_DEPLOY' => 1, // 开启子域名配置
//    'APP_SUB_DOMAIN_RULES' => array(
//        'api.qianbox.net' => 'Api', //第三方回调接口API
//    ),
