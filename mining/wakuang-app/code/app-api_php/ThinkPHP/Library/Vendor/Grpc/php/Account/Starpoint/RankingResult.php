 ...
 *排行返回信息
 *
 * Generated from protobuf message <code>account.starpoint.RankingResult</code>
 */
class RankingResult extends \Google\Protobuf\Internal\Message
{
     ...
     *记录
     *
     * Generated from protobuf field <code>repeated .account.starpoint.RankingRecordsInfo records = 1;</code>
     */
    private $records;
    /**
     *条数
     ...
     *
     * Generated from protobuf field <code>repeated .account.starpoint.RankingRecordsInfo records = 1;</code>
     * @param \Account\Starpoint\RankingRecordsInfo[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setRecords($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Account\Starpoint\RankingRecordsInfo::class);
        $this->records = $arr;
