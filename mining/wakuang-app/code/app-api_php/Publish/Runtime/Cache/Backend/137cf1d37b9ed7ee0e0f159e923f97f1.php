...
<html>
    <head>   
        ...
        <link rel="stylesheet" href="<?php echo (BPATH); ?>style/bootstrap.css" />
        <link rel="stylesheet" href="<?php echo (BPATH); ?>style/bootstrap-responsive.css" />
        <link rel="stylesheet" href="<?php echo (BPATH); ?>fonts/css/font-awesome.min.css" />
        <!--[if lte IE 7]>
            <link rel="stylesheet" href="<?php echo (BPATH); ?>fonts/css/font-awesome-ie7.min.css" />
        <![endif]-->
        <link rel="stylesheet" href="<?php echo (BPATH); ?>style/toastr.css?version=<?php echo (BNO); ?>" />
        <link rel="stylesheet" href="<?php echo (BPATH); ?>style/qianbox.css?version=<?php echo (BNO); ?>" />   
        <script src="<?php echo (BPATH); ?>js/jquery.min.js"></script>
        <script src="<?php echo (BPATH); ?>js/bootstrap.min.js"></script>   
        <script src="<?php echo (BPATH); ?>js/toastr.js"></script> 
        <script type="text/javascript" src="<?php echo (BPATH); ?>js/encrypt.js" ></script> 
        <script type="text/javascript" src="<?php echo (BPATH); ?>js/back.js" ></script> 
        ...
        <div class="login">
            ...
            <form class="row-fluid" id="form-login">
                <div class="input-group">
                    <input type="text" id="userName" name="userName" class="form-control" placeholder="用户名" aria-describedby="basic-addon2">
                    <span class="input-group-addon" id="basic-addon2"><i class="icon-user"></i></span>
                </div>
                <div class="input-group">
                    <input type="password"  id="password" name="password" class="form-control" placeholder="请输入密码" aria-describedby="basic-addon2">
                    <span class="input-group-addon" id="basic-addon2"><i class="icon-lock"></i></span>
                </div>
                <div class="input-group">
                    <input type="text" class="form-control" id="imgCode" name="imgCode" placeholder="验证码" aria-describedby="basic-addon2" >
                    <span id="CaptchaSmsImageHead" class="input-group-addon" style="padding: 0 45px" id="basic-addon2"><img id="txtimg" src="/Backend/Login/verifyImage/" onclick="this.src = '/Backend/Login/verifyImage/' + Math.random()"   class="absolute yzm" title="点击刷新"></span>
                </div>

                <!--<div class="input-group">-->
                    <!--<input type="text" id="smCode" name="smCode" class="form-control" placeholder="短信验证码" >-->
