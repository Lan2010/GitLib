...
(function() {
     ...
     */
    var URL = window.UEDITOR_HOME_URL || "/Public/plugins/ueditor/";
    ...
    window.UEDITOR_CONFIG = {
        ...
        UEDITOR_HOME_URL: URL
                ...
                // 服务器统一请求接口路径
        , serverUrl:"/Backend/BaseEnd/uploader"

                //工具栏上的所有的功能按钮和下拉框，可以在new编辑器的实例时选择自己需要的从新定义
        , toolbars: [[
                'fullscreen', 'source', '|', 'undo', 'redo', '|',
                'bold', 'italic', 'underline', 'removeformat', 'formatmatch', 'autotypeset', '|', 'forecolor', 'backcolor', 'insertorderedlist', 'insertunorderedlist', 'cleardoc', '|',
